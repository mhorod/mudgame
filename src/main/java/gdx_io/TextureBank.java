...
public class TextureBank implements io.model.engine.TextureBank {
    ...
    public TextureBank() {
        ...
        textures.put(io.model.textures.Texture.MUD, new TextureRegion(ui, 109, 970, 349, 127));
        ...
        textures.put(io.model.textures.Texture.ATTACK_MARKER, new TextureRegion(units, 320, 747, 145, 145));
